...
\section{Experiments}
In this section I will compare the different enhancements and how much of a difference they make. The time for the AI was 10 minutes across all experiments on a board size 7.
In order to see which enhancement was the most effective I let different versions of the AI play against itself.
Surprisingly, it seemed that the one who started first won in about 96\% of the games.
