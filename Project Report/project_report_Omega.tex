...
Additionally, the current score of both players is also taken into account. In order to favour in the early game the heuristic value and later in the game the current score a discard factor depending on the remaining moves weighs both of these values.
